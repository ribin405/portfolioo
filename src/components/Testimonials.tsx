      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <AnimateOnScroll>
          <div className="relative">
            {/* Quote card */}
            <div className="relative p-5 sm:p-8 md:p-12 rounded-2xl bg-white/[0.02] border border-white/[0.06] overflow-hidden min-h-[260px] sm:min-h-[260px] flex items-center">
              {/* Decorative quote */}
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <p className="text-sm sm:text-lg md:text-xl text-zinc-300 leading-relaxed mb-6 sm:mb-8 italic">
            ...
            <div className="flex items-center justify-center gap-3 sm:gap-4 mt-6">
              <button
                onClick={prev}
                className="w-11 h-11 rounded-full bg-white/[0.05] border border-white/[0.08] flex items-center justify-center text-zinc-400 hover:text-white hover:bg-white/[0.1] transition-all cursor-pointer"
