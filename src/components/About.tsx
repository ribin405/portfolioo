              ...
              {aboutData.highlights.map((item, i) => {
                ...
                return (
                  <AnimateOnScroll key={i} delay={i * 0.1} direction="up">
                    <div className="group p-4 rounded-xl bg-white/[0.03] border border-white/[0.06] hover:bg-white/[0.06] hover:border-white/[0.12] transition-all duration-300 text-center">
