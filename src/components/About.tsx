      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <AnimateOnScroll direction="left">
            <div className="relative group mx-auto lg:mx-0 max-w-sm md:max-w-md">
              ...
              {aboutData.highlights.map((item, i) => {
                ...
                return (
                  <AnimateOnScroll key={i} delay={i * 0.1} direction="up">
                    <div className="group p-3 sm:p-4 rounded-xl bg-white/[0.03] border border-white/[0.06] hover:bg-white/[0.06] hover:border-white/[0.12] transition-all duration-300 text-center">
                      <Icon className="w-5 h-5 text-indigo-400 mx-auto mb-2" />
                      <div className="text-xl font-bold font-outfit text-white mb-1">
                        {item.value}
                      </div>
