          ...
          {achievementsData.map((item, i) => {
            ...
            return (
              <AnimateOnScroll key={i} delay={i * 0.1} direction="up">
                <div className="group relative p-4 sm:p-6 rounded-2xl bg-white/[0.02] border border-white/[0.06] hover:bg-white/[0.05] hover:border-indigo-500/30 transition-all duration-500 text-center">
                  ...
                  <div className="text-3xl md:text-4xl font-bold font-outfit text-white mb-2">
